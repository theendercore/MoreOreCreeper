...
modSettings {
    entrypoint("main", "org.teamvoided.more_ore_creeper.MoreOreCreeper::init")
    entrypoint("client", "org.teamvoided.more_ore_creeper.client.MoreOreCreeperClient::init")
    entrypoint("fabric-datagen", "org.teamvoided.more_ore_creeper.data.gen.MoreOreCreeperData")
